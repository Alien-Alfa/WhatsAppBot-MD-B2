...
let handler  = async (m, _2) => {
  let { msgsz, usedPrefix, command, text, noPrefix, args, groupMetadata } = _2
  ...
  try {
    ...
    let exec = new (async () => {}).constructor('print', 'm', 'handler', 'require', 'msgsz', 'Array', 'process', 'args', 'groupMetadata', 'module', 'exports', 'argument', _text)
