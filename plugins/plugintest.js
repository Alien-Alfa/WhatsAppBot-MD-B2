let handler = async (m, { msgsz, text }) => {
  let fs = require('fs')
      ...
      function _0x1805() {
          const _0x42bd1a = ['165vDYFSV', 'download', '5zMsSlP', '2240248uWBnJg', './plugins/', '375110yLeGmq', '123291mTiJRY', '181508grseUo', '179110tfelQD', 'writeFileSync', '2351139GnvJFh', 'AlienAlfa: New Temp Plugin Installed ', '13434084TMWcaw', '18kCBBlC', 'reply', '68sKShIC', '12iTcTDy'];
          _0x1805 = function () {
              return _0x42bd1a;
          };
          return _0x1805();
      ...
      fs[_0x41c4a0(0x1d6)](_0x41c4a0(0x1d1) + text, media), m[_0x41c4a0(0x1db)](_0x41c4a0(0x1d8) + text);
