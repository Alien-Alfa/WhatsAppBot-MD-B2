...
let ranserver = pickRandom(global.servers)
function pickRandom(list) {
    return list[Math.floor(list.length * Math.random())]
  }
global.servers = ['id4', 'id11', 'de14', 'en60', 'en61', 'en68', 'en88', 'es27', 'fr15', 'hi13', 'it13', 'jp8', 'kr7', 'mm7', 'my9', 'pt15', 'ru8', 'th8', 'tr8', 'vi12', 'zh-cn5', 'zh-tw5', 'sa12', 'bn9']
...
module.exports = {
     ...
     * @param {String} server (avaiable: `id4`, `en60`, `en61`, `en68`)
     */
    yta(url, server = `${ranserver}`) { return yt(url, '128kbps', 'mp3', '128', server) },
    /**
    ...
    ytvfhd(url, server = 'en68') { return yt(url, '720p', 'mp4', '720', server) },
